  ...
  if (!item) return (
    <div>
      ...
      <div className="xui-py-2">
        <a onClick={() => router.push('/dashboard/candidate-portal/posts')} className="xui-w-40 xui-h-40 xui-bdr-rad-circle xui-bg-light xui-text-inherit xui-d-inline-flex xui-flex-ai-center xui-flex-jc-center xui-mb-1 xui-cursor-pointer">
    ...
    <div>
      ...
      <div className="xui-py-1">
        <div className="xui-d-flex xui-flex-ai-center xui-flex-jc-space-between xui-mb-1-half">
          <a
            onClick={() => router.push('/dashboard/candidate-portal/posts')}
          ...
          {canEdit && (
            <button
              type="button"
              onClick={() => router.push(`/dashboard/candidate-portal/posts/edit/${item.unique_id}`)}
                ...
                <div className="xui-d-flex xui-flex-dir-column xui-grid-gap-1">
                  ...
                  {item.Candidate && (
                    <div className="xui-d-flex xui-flex-jc-space-between xui-flex-ai-center">
                      ...
                      <span className="xui-font-sz-80 xui-font-w-500" style={{ color: 'var(--neutral-700)' }}>{item.Candidate.name}</span>
                    </div>
                  )}

...
const EditEvent = () => {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      else { setSuccessMessage('Event updated successfully'); showAlert('success-alert'); setTimeout(() => router.push('/dashboard/candidate-portal/events'), 1500); }

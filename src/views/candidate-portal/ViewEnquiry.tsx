...
const ViewEnquiry = () => {
  ...
  const handleMarkComplete = async () => {
    ...
    return enquiriesService.complete(item.unique_id, { module_unique_id: moduleId, sub_module_unique_id: subModuleId });
  };
  ...
  return (
    <div>
      ...
      <div className="xui-py-1">
        <a
          onClick={() => router.push('/dashboard/candidate-portal/enquiries')}

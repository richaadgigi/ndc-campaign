...
const AllMembers = () => {
  ...
  const accessIds = getAccessIds('candidate-portal', 'members');
      ...
      <div className="xui-py-1-half">
        <div className="xui-d-flex xui-flex-ai-center xui-flex-jc-space-between xui-mb-1-half">
          ...
          <div className="xui-d-flex xui-flex-ai-center xui-grid-gap-half">
            ...
            {canAdd && (
              <button onClick={() => router.push('/dashboard/candidate-portal/members/add')} className="xui-btn xui-font-sz-80 xui-bdr-rad-half xui-font-w-500 xui-d-flex xui-flex-ai-center xui-grid-gap-half" style={{ backgroundColor: 'var(--primary-600)', color: 'var(--secondary-700)' }}>
                ...
                <tbody>
                  {items.map((member) => (
                    <tr key={member.unique_id}>
                      ...
                      <td className="xui-font-sz-85 xui-opacity-7">{member.Candidate?.name || '-'}</td>

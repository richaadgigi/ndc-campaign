...
const AllFileStorage = () => {
  ...
  const handleDeleteItem = async () => {
    ...
    return fileStorageService.delete(selectedItem.unique_id, { module_unique_id: moduleId, sub_module_unique_id: subModuleId });
  };
      ...
      <div className="xui-py-1-half">
        <div className="xui-d-flex xui-flex-ai-center xui-flex-jc-space-between xui-mb-1-half">
          ...
          <div className="xui-d-flex xui-flex-ai-center xui-grid-gap-half">
            ...
            {canAdd && (
              <button onClick={() => router.push('/dashboard/candidate-portal/file-storage/add')} className="xui-btn xui-font-sz-80 xui-bdr-rad-half xui-font-w-500 xui-d-flex xui-flex-ai-center xui-grid-gap-half" style={{ backgroundColor: 'var(--primary-600)', color: 'var(--secondary-700)' }}>

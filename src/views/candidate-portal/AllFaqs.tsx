...
const AllFaqs = () => {
  ...
  const accessIds = getAccessIds('candidate-portal', 'faqs');
  ...
  const handleDeleteItem = async () => {
    ...
    return faqsService.delete(selectedItem.unique_id, { module_unique_id: moduleId, sub_module_unique_id: subModuleId });
  };
      ...
      <div className="xui-py-1-half">
        <div className="xui-d-flex xui-flex-ai-center xui-flex-jc-space-between xui-mb-1-half">
          ...
          <div className="xui-d-flex xui-flex-ai-center xui-grid-gap-half">
            ...
            {canAdd && (
              <button onClick={() => router.push('/dashboard/candidate-portal/faqs/add')} className="xui-btn xui-font-sz-80 xui-bdr-rad-half xui-font-w-500 xui-d-flex xui-flex-ai-center xui-grid-gap-half" style={{ backgroundColor: 'var(--primary-600)', color: 'var(--secondary-700)' }}>
                        ...
                        <td>
                          <div className="xui-tooltip" xui-set="left">
                            ...
                            <div className="xui-tooltip-content xui-flex-ai-center xui-grid-gap-half" style={{ display: 'flex', maxWidth: '500px' }}>
                              {canEdit && (
                                <button onClick={() => router.push(`/dashboard/candidate-portal/faqs/edit/${item.unique_id}`)} className="xui-btn xui-btn-small xui-d-flex xui-flex-ai-center xui-grid-gap-half xui-cursor-pointer xui-font-sz-80" style={{ backgroundColor: 'var(--info-light)', border: 'none', color: 'var(--info)' }}><Edit size={16} /> Edit</button>
                              )}
                              {canDelete && (
